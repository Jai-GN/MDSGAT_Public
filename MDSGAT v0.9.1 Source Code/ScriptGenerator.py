...
class MDSScriptGen:
    def __init__(self, Script_Settings, MDS_Options, Hardware_Options, Advanced_Options, ION_MDP, MIN_MDP, NVT_MDP, NPT_MDP,  PROD_MDP, ConfigFile):
    ...
    def Generate_MDS_Setup_Script(self):
        ...
        Variables = ("### Assign User Generated Variables ###\n" +
                     ...
                     f"Project = '{Config_Data["Selected Configuration"]["Project Name"]}'\n" +
                     f"Default_Build = '{Config_Data["Selected Configuration"]["Default Build"]}'\n" +
                     f"GPU_Build = '{Config_Data["Selected Configuration"]["GPU Build"]}'\n" +
                     f"MPI_Build = '{Config_Data["Selected Configuration"]["MPI Build"]}'\n" +
                     f"MPI_GPU_Build = '{Config_Data["Selected Configuration"]["MPI + GPU Build"]}'\n\n"
                     )
